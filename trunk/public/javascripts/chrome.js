...
showhide:function(obj, e){
	for(var i=1;i<=2;i++){
		document.getElementById((this.dropmenuobj.id)+i).style.display = '';
		document.getElementById((this.dropmenuobj.id)+i).style.marginTop = '3px';
	}
	for(var i=1;i<=2;i++){
		if(document.getElementById('d'+(this.dropmenuobj.id)+i) != null){
			document.getElementById('d'+(this.dropmenuobj.id)+i).style.display = '';
		}			
	}
...
hidemenu:function(){
	for(var i=1;i<=2;i++){
		document.getElementById((this.dropmenuobj.id)+i).style.display = 'none';
	}
	for(var i=1;i<=2;i++){
		if(document.getElementById('d'+(this.dropmenuobj.id)+i) != null){
			document.getElementById('d'+(this.dropmenuobj.id)+i).style.display = 'none';
		}
	}			
